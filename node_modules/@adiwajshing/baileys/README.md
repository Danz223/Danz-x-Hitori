...
// pesan hydrate (kalau ga work, pastikan sudah ngikutin tutor diatas. jika etap tidak fungsi, silahkan lapor ke grup)
sock.sendMessage(jid, {
text: "Hello world",
footer: "© Amirul Dev",
templateButtons: [
{index: 1, urlButton: { displayText: "URL BUTTON", url: `https://fb.com/amiruldev.ci`}},
{index: 2, callButton: { displayText: "Call Button", phone: "6285157489446"}},
{index: 3, quickReplyButton: {
displayText: "THIS BUTTON", id: "ID"}}
] })
